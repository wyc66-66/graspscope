#!/usr/bin/env python3
"""Render the GraspScope technical report Markdown -> styled HTML -> PDF.

Uses the Python `markdown` package for HTML and headless Edge for PDF
(no external network deps; no GTK/libmspack requirement).

Outputs under docs/paper/graspscope/:
    graspscope_paper.html   styled standalone HTML (openable in any browser)
    graspscope_paper.pdf    print-to-pdf via headless Edge
"""
...
PAPER = ROOT / "docs" / "paper" / "graspscope"
SRC = PAPER / "graspscope_paper.md"
FIG = PAPER / "figures"
OUT_HTML = PAPER / "graspscope_paper.html"
OUT_PDF = PAPER / "graspscope_paper.pdf"
